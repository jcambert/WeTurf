...
namespace We.Turf.Migrations
{
    ...
    [Migration("20230522174205_view_resultatofpredictedwithoutclassifier")]
    partial class viewresultatofpredictedwithoutclassifier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("We.Turf.Entities.AccuracyPerClassifier", b =>
                {
                    ...
                    b.Property<int>("PredictionCount")
                        .HasColumnType("integer")
                        .HasColumnName("predictioncounting");

                    b.Property<int>("ResultatCount")
                        .HasColumnType("integer")
                        .HasColumnName("resultatcounting");

                    b.ToTable((string)null);

                    b.ToView("turfaccuracyperclassifier", (string)null);
                });

            modelBuilder.Entity("We.Turf.Entities.Classifier", b =>
                {
                    b.Property<string>("Name")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.ToView("turfclassifier", (string)null);
                });

            modelBuilder.Entity("We.Turf.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DistanceUnite")
                        .HasColumnType("text");

                    b.Property<string>("HippoCode")
                        .HasColumnType("text");

                    b.Property<string>("HippoCourt")
                        .HasColumnType("text");

                    b.Property<string>("HippoLong")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("MontantPrix")
                        .HasColumnType("integer");

                    b.Property<int>("NombrePartants")
                        .HasColumnType("integer");

                    b.Property<int>("Numero")
                        .HasColumnType("integer");

                    b.Property<string>("OrdreArrivee")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("HippoCode");

                    b.HasIndex("Numero");

                    b.HasIndex("Reunion");

                    b.ToTable("turfcourse", (string)null);
                });

            modelBuilder.Entity("We.Turf.Entities.LastScrapped", b =>
                {
                    b.Property<DateTime>("LastDate")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("lastscrappeddate");

                    b.ToTable((string)null);

                    b.ToView("turfllastscrapped", (string)null);
                });

            modelBuilder.Entity("We.Turf.Entities.Parameter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("BaseScrapFolder")
                        .HasColumnType("text");

                    b.Property<string>("CourseFilename")
                        .HasColumnType("text");

                    b.Property<string>("InputScrapFolder")
                        .HasColumnType("text");

                    b.Property<string>("InputScrapFolderMonthPattern")
                        .HasColumnType("text");

                    b.Property<string>("OutputScrapFolder")
                        .HasColumnType("text");

                    b.Property<string>("PredictionFilename")
                        .HasColumnType("text");

                    b.Property<bool>("ScrapInFolder")
                        .HasColumnType("boolean");

                    b.HasKey("Id");

                    b.ToTable("turfparameter", (string)null);
                });
            ...
            modelBuilder.Entity("We.Turf.Entities.PredictionByDate", b =>
                {
                    b.Property<int>("Course")
                        .HasColumnType("integer");
                    ...
                    b.ToView("turfpredictionbydate", (string)null);
                });
            ...
            modelBuilder.Entity("We.Turf.Entities.ProgrammeCourse", b =>
                {
                    b.Property<int>("Course")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("We.Turf.Entities.ResultatOfPredicted", b =>
                {
                    b.Property<string>("Classifier")
                        .HasColumnType("text");
                    ...
                    b.Property<double?>("Dividende")
                        .HasColumnType("double precision")
                        .HasColumnName("dividende");
                    ...
                    b.Property<Guid?>("Resultat_Id")
                        .HasColumnType("uuid")
                        .HasColumnName("resultat_id");
            ...
            modelBuilder.Entity("We.Turf.Entities.Stat", b =>
                {
                    b.Property<string>("Classifier")
                        .HasColumnType("text");
                    ...
                    b.ToView("turfstat", (string)null);
                });

            modelBuilder.Entity("We.Turf.Entities.StatByDate", b =>
                {
                    b.Property<string>("Classifier")
                        .HasColumnType("text");
                    ...
                    b.ToView("turfstatbydate", (string)null);
                });
