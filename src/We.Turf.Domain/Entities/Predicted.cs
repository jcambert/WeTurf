...
[DebuggerDisplay("{Classifier}-{Date}-{Reunion}-{Course}-{NumeroPmu}-{Nom}-{Rapport}-{Specialite}-{Hippodrome}")]
public class Predicted:Entity<Guid>
{
    ...
    public override string ToString() => $"{Classifier}-{Date}-{Reunion}-{Course}-{NumeroPmu}-{Nom}-{Rapport}-{Specialite}-{Hippodrome}";
