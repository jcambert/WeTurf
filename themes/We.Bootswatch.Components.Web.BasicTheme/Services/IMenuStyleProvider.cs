...
public class MenuStyleProvider : SelectorProvider<IWeMenuStyle>, IMenuStyleProvider
{
    ...
    public MenuStyleProvider(IAbpLazyServiceProvider serviceProvider, IHttpContextAccessor context, NavigationManager navigationManager) : base(serviceProvider,context, navigationManager)
    {
    }
