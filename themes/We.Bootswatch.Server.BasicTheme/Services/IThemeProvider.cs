...
internal abstract class Theme : ITheme
{
    ...
    internal static readonly List<ITheme> Themes = new List<ITheme>();
...
public class ThemeProvider : SelectorProvider<ITheme>, IThemeProvider
{
    ...
    public ThemeProvider(IHttpContextAccessor context, NavigationManager navigationManager) : base(context,navigationManager)
    {
